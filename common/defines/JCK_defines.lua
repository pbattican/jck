NDefines = {
    NGame = {
        GAME_SPEED_SECONDS = { 1, 0.3, 0.175, 0.1, 0.0 },
    },

    NCountry = {
        MAX_HEROES_BEING_KILLED_WAR_SUPPORT_IMPACT = -0.4,
        ...
        --- EVENT_PROCESS_OFFSET = 5,

    },

    NFocus = {
        MAX_SAVED_FOCUS_PROGRESS = 20,
    },

    NMilitary = {
        --- More XP gain per day of combat. Base is 3
        FIELD_EXPERIENCE_MAX_PER_DAY = 3.5,

        --- Encourage more Lend-Lease for XP gain. Base is 0.005
        LEND_LEASE_FIELD_EXPERIENCE_SCALE = 0.0055,

        --- Boost Max XP so it is not lost to the ether
        MAX_ARMY_EXPERIENCE = 1000,
        MAX_NAVY_EXPERIENCE = 1000,
        MAX_AIR_EXPERIENCE = 1000,
    },
